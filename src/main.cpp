...
ez::tracking_wheel horiz_tracker(9, 2, 0);  // This tracking wheel is perpendicular to the drive wheels
ez::tracking_wheel vert_tracker(12, 2, 0);   // This tracking wheel is parallel to the drive wheels
...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      {"Wall Tracking", blue_top_elims/*Setting up the PID odom_drive_example// turn_example/*drive_example*/},
