...
void right_elims_quick(){
  ...
  chassis.pid_wait();
  trapdoor.set(true);
  chassis.pid_drive_set(1, 1, true);
}
...
void left_safe(){
  ...
  pros::delay(100);
  trapdoor.set(true);
  chassis.pid_drive_set(-16.5, 80, true);
  chassis.pid_wait();
  ...
  pros::delay(300);
  //drive_wall(450);
  while (distance_front.get_distance() > 700){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  chassis.pid_drive_set(14.5, 60, true);
  chassis.pid_wait();
...
void right_safe(){
 pros::Task contor1 (controller_update);
  ...
  bottom_intake(127);
  trapdoor.set(false);
  chassis.pid_drive_set(31, 100, true);
  pros::delay(500);
  Little_Mech_Mac.set(true);
  chassis.pid_wait();
  ...
  pros::delay(200);
  trapdoor.set(true);
  chassis.pid_drive_set(11.5, 80, true);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(92, 60, true);
  chassis.pid_wait();
  pros::delay(300);
  //drive_wall(450);
  while (distance_front.get_distance() > 720){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  chassis.pid_turn_set(-175, 80, true);
  chassis.pid_wait();
...
void solo_left() {
  ...
  chassis.pid_swing_set(RIGHT_SWING, 46.2, 74, -21.5, true); 
  chassis.pid_wait();
  trapdoor.set(0);
...
void skills() {  
  ...
  */
  ...
  chassis.pid_odom_set({{-45 * 1.08, 0}, fwd, 100}, true);
  chassis.pid_wait();
  ...
  */
  ...
  chassis.pid_odom_set({{-46 * 1.08, 90 * .9}, fwd, 110}, true);
  chassis.pid_wait();
  chassis.pid_turn_set(0, 60, true);
  chassis.pid_wait();
  pros::delay(100);
  ...
  */
  trapdoor.set(0);
  chassis.pid_drive_set(45.5, 60, true);
  chassis.pid_wait();
  ...
  */
  ...
  while (distance_front.get_distance() > 730 * distance_multiplier){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  while (distance_front.get_distance() > 756 * distance_multiplier* 1.04){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
