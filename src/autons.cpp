...
void controller_update() {
  while (true) {
    if (screen == 0) {
      master.print(0, 0, "%f          ", (vertical_tracker.get_position()/36000* 2 * 3.14)/*, intake_bottom.get_current_draw(),distance_front.get_distance()*/);
      pros::delay(100);
    } else {
...
void left_safe(){
  ...
  while (distance_front.get_distance() > 722){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  chassis.pid_drive_set(-32, 80, true);
  pros::delay(200);
  intake_top.move(127);
  chassis.pid_wait();

  chassis.pid_drive_set(-1000, 10, true);
  pros::delay(900);
...
void right_safe1(){
  ...
  chassis.pid_drive_set(-34, 80, true);
  chassis.pid_wait();
  intake_top.move(127);
  pros::delay(900);
...
void right_safe(){
  ...
  chassis.pid_odom_set({{10_in, 30.5_in}, fwd, 60}, true);
  pros::delay(100);
  intake_top.move(-40);
  ...
  while (distance_front.get_distance() > 715){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  chassis.pid_turn_set(-178.5, 80, true);
  chassis.pid_wait();

  intake_bottom.move(127);

  chassis.pid_drive_set(12.6, 60, true);
  chassis.pid_wait();
...
void solo_right (){
  ...
  while (distance_front.get_distance() > 645){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  chassis.pid_swing_set(LEFT_SWING, -55, 90, -17, true);
  chassis.pid_wait();

  chassis.pid_drive_set(32, 45, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(5.7, 60, true);  
  chassis.pid_wait();
...
void left_elims() {
  ...
  chassis.pid_swing_set(RIGHT_SWING, 115, 75, 15);
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(25, 60, true);
  chassis.pid_wait_quick();
  ...
  chassis.pid_turn_set(174, 60, true);
  chassis.pid_wait_quick();
  ...
  chassis.pid_drive_set(24, 55, true);
  chassis.pid_wait();
  // intake_bottom.move(127);
  bottom_intake(127);
  pros::delay(600);
  ...
  chassis.pid_drive_set(-27.2, 70, true);
  chassis.pid_wait();
...
void skills() {  
  ...
  */
  ...
  chassis.pid_odom_set({{-35.8_in, 0_in}, fwd, 127}, true);
  chassis.pid_wait();
  
  bottom_intake(127);
  top_intake(127);
  // while (distance_front.get_distance() > 490){
  //   chassis.pid_drive_set(1000000, 50);
  // }
  // L1.brake();
  // L2.brake();
  ...
  */
  ...
  chassis.pid_odom_set({{-49_in, 0_in}, fwd, 100}, true);
  chassis.pid_wait();
  ...
  */
  ...
  chassis.pid_odom_set({{-51_in, 90_in}, fwd, 110}, true);
  chassis.pid_wait();
  chassis.pid_turn_set(0, 60, true);
  chassis.pid_wait();
  pros::delay(100);
  ...
  */
  ...
  chassis.pid_odom_set({{10.2_in, 0_in}, fwd, 110}, true);
  chassis.pid_wait();
  screen = 1;
  ...
  */
  ...
  chassis.pid_drive_set(29.5, 100, true);
  ...
  */
  ...
  // chassis.pid_odom_set({{64, -5}, fwd, 100}, true);
  // chassis.pid_wait();

  chassis.pid_turn_set(55, 60, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(28.5, 60, true);
  chassis.pid_wait();
  ...
  */
  ...
  chassis.pid_drive_set(12.8, 60, true);
  chassis.pid_wait();
  ...
  */
  ...
  while (distance_front.get_distance() > 760){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  while (distance_front.get_distance() > 776){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  */
  ...
  chassis.pid_drive_set(17.5, 60, true);
  chassis.pid_wait();
  ...
  */
  ...
  chassis.pid_drive_set(29.5, 80, true);
  trapdoor.set(1);
  ...
  */
  ...
  chassis.pid_drive_set(-31.5, 60, true);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(177, 127, true);
  chassis.pid_wait_quick();
...
void new_elim_auton(){
  ...
  top_intake(120);
  bottom_intake(120);
  chassis.odom_xyt_set(0_in, 0_in, 162_deg);

  // chassis.pid_turn_set(0_deg, 60);
  // chassis.pid_wait();
  chassis.pid_odom_set({{-14.3_in, 35_in}, rev, 127});
  chassis.pid_wait();

  chassis.pid_turn_set(180_deg, 60);
  chassis.pid_wait();

  chassis.pid_odom_set({{-14.4_in, 46.5_in}, rev, 127});
  pros::delay(200);
  left_rush_mech.set(1);
  chassis.pid_wait();
  intake_bottom.move(127);

  chassis.pid_swing_set(RIGHT_SWING, 135, 60);
  chassis.pid_wait_quick();
  ...
  pros::delay(200);
  left_rush_mech.set(0);
  pros::delay(250);
  chassis.pid_drive_set(-20, -80, true);
  chassis.pid_wait_quick();

  chassis.pid_turn_set(168, 60, true);
  intake_bottom.move(80);
  intake_top.move(0);
  chassis.pid_wait_quick();

  chassis.pid_swing_set(RIGHT_SWING, 130, 80, 50, true);
  chassis.pid_wait_quick();
...
void solo_winpoint_left() {
  ...
  chassis.pid_odom_set({{-35.8, 0}, fwd, 80}, true);
  chassis.pid_wait_quick();
  ...
  chassis.pid_swing_set(RIGHT_SWING, 46.2, 70, -10.5, true); 
  chassis.pid_wait();

  chassis.pid_drive_set(35, 60, true);
  pros::delay(700);
  Little_Mech_Mac.set(1);
  chassis.pid_wait();

  intake_top.move(-35);
  intake_bottom.move(-35);
  ...
  chassis.pid_odom_set({{18_in, 28_in}, fwd, 127}, true);
  chassis.pid_wait_quick_chain();
  ...
  intake_top.move(-100);
  intake_bottom.move(-50);
  chassis.pid_turn_set(-61, 60, false);
  chassis.pid_wait_quick();
  intake_bottom.set_brake_mode(MOTOR_BRAKE_COAST);



  chassis.pid_swing_set(LEFT_SWING, -37, 70, 52);
  chassis.pid_wait_quick();
