...
void left_elims_7ball(){
  ...
  chassis.pid_drive_set(15.5, 70, true);
  Little_Mech_Mac.set(1);
  chassis.pid_wait();
  pros::delay(300);
  ...
  chassis.pid_turn_set(-160, 40, false);
  chassis.pid_wait();
...
void left_elims_quick(){
  ...
  chassis.pid_turn_set(175, 100, true);
  chassis.pid_wait_quick_chain();

  chassis.pid_swing_set(LEFT_SWING, 90, 80, 0, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(70, 40, false);
  chassis.pid_wait();
...
void new_skills(){
  ...
  chassis_drive_wall(600, 127);
  
  chassis.pid_turn_set(-88, 80, true);
  chassis.pid_wait();

  chassis_drive_wall(1450, 127);
  ...
  chassis.pid_drive_set(8.9, 60, true);
  chassis.pid_wait();
  pros::delay(1050);
  ...
  chassis.pid_drive_set(27.7, 60, true);
  chassis.pid_wait();
  pros::delay(1050); 
  ...
  chassis.pid_swing_set(LEFT_SWING, 87, 85, 30, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_drive_exit_condition_set(90_ms, 1_in, 300_ms, 3_in, 600_ms, 600_ms);

  Little_Mech_Mac.set(1);
  pros::delay(200);
  Little_Mech_Mac.set(0);

  chassis.pid_drive_set(50, 75, true); 
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_exit_condition_set(90_ms, 1_in, 200_ms, 3_in, 100_ms, 100_ms);

  chassis_drive_wall(560, 100);
  ...
  chassis.pid_turn_set(80, 80, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(80, 60, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_drive_set(42.5, 80, true);
  chassis.pid_wait_quick_chain();

  chassis.pid_turn_set(30, 60, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(129, 80, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_drive_set(53, 80, true);
  chassis.pid_wait_quick_chain();

  //score first match loader

  chassis.pid_turn_set(-125, 100, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(-178, 80, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_swing_set(LEFT_SWING, -3, 85, 29, true);
  chassis.pid_wait_quick_chain();
...
void skills() {
  pros::Task task_anti_jam(anti_jam_auton);
  ...
  while (distance_front_l.get_distance() > 580){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  chassis.pid_drive_set(-33.5, 80, true);
  // pros::delay(800);
  // top_intake(-30);
  // bottom_intake(-30);
  // top_intake_score(30);
  ...
  chassis.pid_drive_set(70, 100, true);
  pros::delay(250);
  Little_Mech_Mac.set(1);
  pros::delay(800);
  Little_Mech_Mac.set(0);
  ...
  */
  ...
  while (distance_front_l.get_distance() > 610){
    chassis.pid_drive_set(1000000, 40);
  }
  L1.brake();
  L2.brake();
  ...
  chassis.pid_drive_set(8.5, 127, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(-94, 80, true);
  chassis.pid_wait_quick_chain();
...
void nor_call_skills() {
  ...
  /*Try #2
  chassis.pid_swing_set(LEFT_SWING, 90, 127, 100, false); 
  pros::delay(1000); 
  chassis.pid_swing_set(RIGHT_SWING, -90, 127, 100, false);  
  pros::delay(1000);
  chassis.pid_drive_set(10, 127, true);
  pros::delay(5000);
  */
