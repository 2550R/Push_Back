...
void blue_top_elims(){
  ...
  chassis.pid_odom_set({{{-14_in, 18_in}, rev, 127},
                      {{-12_in, 22_in}, rev, 127},
                      {{-11.8_in, 30_in}, rev, 110},
                      {{-11_in, 45.3_in}, rev, 110}},
                      true);
  chassis.pid_wait();
  ...
  chassis.pid_swing_set(LEFT_SWING, 160, 60,5);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(-22, 60, true);
  chassis.pid_wait();
  ...
  chassis.pid_odom_set({{-8_in, 16_in}, fwd, 80}, true);
  chassis.pid_wait();
